...
<center>
    ...
    <div><table>
        ...
        <tr>
         ...
         <tr>
          ...
          <td colspan="7">
            ...
            <?php echo $mostrar['acta_regis']?></h5></label>
            </div>
            </td>
         </tr>
        ...
        <tr>
         <td colspan="1">
            ...
            <div class="form-group">
              ...
              <label>5 min:  <?php echo $mostrar['APGAR_NV5']?></label>
            </div>
        </td>
      ...
      <tr>
        ...
        $sql="SELECT `ID_DOC`, `ID_ESTABL`, `TIPO_DOC`, `Espe_Doc`, `NOMBRE_DOC`, `APEL_DOC`, `TELEF_DOC`, `CEDUL_DOC`, `OBSERVACION_DOC` FROM `doctor` WHERE ID_DOC = '$id_E'";
